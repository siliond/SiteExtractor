...
function getAddresses() {
    ...
    jQuery(function($) {
        ...
        $(jPath).each(function() {
            ...
            if (address.match(/^ *$/) == null && !previousAddresses.includes(address) && !addresses.includes(address))
